...
class Parser():
    def __init__(self):
        ...
        self.p.add_argument('--seed', type=int, default=1, 
                help='random seed')
        #Temporary Victor looking at softmax on/off
        self.p.add_argument('--toggle_softmax', action='store_true', default=False, 
                help='whether or not you should toggle for checking difference in softmax')
        self.p.add_argument('--train_passes', type=int, default=1, 
                help='number of forward passes to average during training')        
        ...
        self.p.add_argument('--temp_plateau_epochs', type=int, default=50)
